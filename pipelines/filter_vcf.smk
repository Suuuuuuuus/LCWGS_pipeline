...
rule filter_oneKG_low_confidence_regions:
    input:
        filtered_vcf = "results/wip_vcfs/{panel_name}/vanilla/high_info_high_af/lc.chr{chr}.vcf.gz"
    output:
        filtered_vcf = temp("results/wip_vcfs/{panel_name}/vanilla/high_info_high_af_high_conf/lc.chr{chr}.vcf"),
...
rule filter_giab_low_confidence_regions:
    input:
        filtered_vcf = "results/wip_vcfs/{panel_name}/vanilla/high_info_high_af/lc.chr{chr}.vcf.gz"
    output:
        filtered_vcf = temp("results/wip_vcfs/{panel_name}/vanilla/high_info_high_af_giab_high_conf/lc.chr{chr}.vcf"),
