...
rule hla_imputation_wip_all:
    input:
        output_db1 = expand('/well/band/users/rbx225/recyclable_files/hla_reference_files/v3390_aligners/{hla_gene}.ssv', hla_gene = hla_genes),
        output_db2 = expand('/well/band/users/rbx225/recyclable_files/hla_reference_files/v3570_aligners/{hla_gene}.ssv', hla_gene = hla_genes),
